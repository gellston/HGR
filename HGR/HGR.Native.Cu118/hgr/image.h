...
#pragma region Public Functions
			...
			/// </summary>
			/// <returns></returns>
			HGR_NATIVE_API uint32_t width();

			/// <summary>
			/// Image height
			/// </summary>
			/// <returns></returns>
			HGR_NATIVE_API uint32_t height();

			/// <summary>
			/// Image channel
			/// </summary>
			/// <returns></returns>
			HGR_NATIVE_API uint32_t channel();

			/// <summary>
			/// Image buffer start pointer
			/// </summary>
			/// <returns></returns>
			HGR_NATIVE_API unsigned char* data();
...
#pragma region Static Functions
			...
			HGR_NATIVE_API static void imwrite(const std::string& path, image_ptr image);
#pragma endregion
