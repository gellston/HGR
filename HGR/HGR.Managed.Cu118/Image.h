...
#pragma region Private Property
		private:
			hgrapi::v1::image_ptr* instance = nullptr;
			bool disposed = false;
#pragma endregion
...
#pragma region Constructor
		internal:
			Image(hgrapi::v1::image_ptr image);
#pragma endregion
...
#pragma region Static Functions
			...
			static Image^ Create(uint32_t width, uint32_t height, uint32_t channel, System::IntPtr buffer, MemoryPool^ pool);
